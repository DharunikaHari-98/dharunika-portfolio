...
function Desktop() {
  ...
  return (
    ...
    >
      ...
      {windows.github && <GitHubApp />}
      {windows.resume && <ResumeApp />}
      {windows.appstore && <AppStoreApp />}
      {windows.contact && <ContactApp />}

      {showSpotlight && (
        <Spotlight closeSpotlight={() => setShowSpotlight(false)} />
      )}

      {showLaunchpad && (
        <Launchpad closeLaunchpad={() => setShowLaunchpad(false)} />
      )}
